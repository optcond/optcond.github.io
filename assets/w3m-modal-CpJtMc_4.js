import{w as ve,p as fe,s as ge,a as be,M as g,S as se,R as l,i as v,r as P,c as f,x as a,A as K,e as ce,d as le,C as m,f as Y,g as ye,h as S,E as ie,O as E,j as q,k as oe,l as T,m as H,T as xe,n as Ce,o as ke,q as Se}from"./core-DuzhXx9O.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-BW3v_SOw.js";import"./supabase-CskpBK-R.js";import"./react-uYZGv8Ap.js";import"./events-DK53yLfj.js";import"./index.es-C3aZIXri.js";import"./index-DK5Qu2OJ.js";import"./query-BPxH1CfV.js";import"./recharts-LuzJWhtN.js";import"./lucide-D1I07J1j.js";import"./fallback-ByuE5Umc.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
